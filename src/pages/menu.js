...
export default function MobileMenu() {
  return (
    <div className="fixed top-0 w-full z-20 block xl:hidden bg-green h-screen">
      <button className="text-lg md:text-2xl px-px text-black invert-select">
        Close
      </button>

      <button
        onClick={() => goBack()}
        className="z-40  fixed top-4 right-4 text-red  transition ease-in-out duration-300 focus:outline-none
           rotate-45"
      >
        <svg
